...
- R Markdown 1.9
- Bioconductor 3.7
- Python 3.6.5 (Installed via Anaconda)
- py2cytoscape 0.6.2
- pandas 0.22.0

## Note about this RMarkdown
This R Markdown document uses **Python3**, and you need to install "reticulate" package.
Please run the following command from your terminal to install the package **before** running this document:
...
##### From terminal
```
pip install --upgrade py2cytoscape requests pandas
```
